	...
	MenuListDecorator(std::move(decoratedMenu))
{
	...
	buttonCharacteristics.insert(std::pair<Maths::IVec2D, std::pair<std::string, std::function<void(int&)>>>(Maths::IVec2D(625, 400), std::make_pair<std::string, std::function<void(int&)>>("Consumables", [](int& out) { printf("Consumable!\n"); out = 0; })));
	buttonCharacteristics.insert(std::pair<Maths::IVec2D, std::pair<std::string, std::function<void(int&)>>>(Maths::IVec2D(625, 450), std::make_pair<std::string, std::function<void(int&)>>("Balls", [](int& out) { printf("Ball!\n"); out = 1; })));
