	...
	MenuListDecorator(std::move(decoratedMenu))
{
	...
	buttonCharacteristics.insert(std::pair<Maths::IVec2D, std::pair<std::string, std::function<void(int&)>>>(Maths::IVec2D(700, 300), std::make_pair<std::string, std::function<void(int&)>>("Save game", [](int& out) {std::cout << "Saving the game!\n"; out = 4; })));
	buttonCharacteristics.insert(std::pair<Maths::IVec2D, std::pair<std::string, std::function<void(int&)>>>(Maths::IVec2D(700, 350), std::make_pair<std::string, std::function<void(int&)>>("Exit to title screen", [](int& out) {std::cout << "Going to title screen!\n"; out = 5; })));
	buttonCharacteristics.insert(std::pair<Maths::IVec2D, std::pair<std::string, std::function<void(int&)>>>(Maths::IVec2D(700, 400), std::make_pair<std::string, std::function<void(int&)>>("Exit game", [](int& out) {std::cout << "Exiting the game!\n"; out = 0; })));
